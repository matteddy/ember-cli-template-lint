  ...
  UnusedBlockParams.prototype.visitors = function() {
    ...
    return {
      Program: {
        ...
        exit: function() {
          if (scope.frameHasUnusedBlockParams()) {
            throw new Error("AHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH: ");
          }
...
Frame.prototype.hasUnusedLocals = function() {
  if (this.locals.length > 0) {
    return !this.usedLocals[this.locals[this.locals.length - 1]];
  } else {
    return false;
  }
}
...
Scope.prototype.frameHasUnusedBlockParams = function() {
  return this.frames[this.frames.length - 1].hasUnusedLocals();
};
